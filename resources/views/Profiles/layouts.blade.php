        ...
        <section class="profile-main-section">
          <div class="container-fluid">
            ...
            <form action="/store/{{$profile->id}}" method = 'POST' enctype="multipart/form-data" >
                ...
                <div class="profile-cover-box">
                <img  class="profile-cover-img" src="/profile-covers/{{$profile->cover}}" alt="Profile Cover Img">
                <label class="change-profile-photo change-cover" for="profileCover">
                    <input id="profileCover" name='profileCover' type="file" accept="image/*" onchange="this.form.submit();">
                    <svg>
                   <use href="{{asset('assets/images/icons/icons.svg#Camera')}}"></use>
                </svg>
