      ...
      <div class="nav-bar-component">
        ...
        <div class="container">
          ...
          <div class="page-background-section"> <img src="../../assets/images/pagesBg.png" alt="pagesBg">
            <h1 class="bg-section-title">التصنيفات</h1>
          </div>
      <main>
            ...
            <div class="container">
              <div class="global-section-layout">
                <div class="row categories-container">
                  ...
                  <div class="col">
                    <a class="card customized-card category-card" href="{{ route('all-books', $category->id) }}">
                      <div class="card-img-box">
                        <img class="card-img-top" src="{{ $category->image_url  }}" alt="technology">
                      </div>
                      <div class="card-body">
